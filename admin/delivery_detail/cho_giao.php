...
$sql = mysqli_query($conn, "SELECT * FROM tbl_order WHERE status = 0 LIMIT " . $per_row . "," . $row_per_page);
$total_record = mysqli_query($conn, "SELECT * FROM tbl_order WHERE status = 0");
