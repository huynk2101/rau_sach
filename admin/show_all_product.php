...
<body>
    ...
    <div class="container-fluid row mt-5">
        <div class="col-3">
            ...
            <a href="add_product.php" target="blank" class="border" >Thêm sản phẩm</a><br>
            <a href="show_all_category.php" target="blank" class="border" >Danh mục</a>
        </div>
        <div class="col-9">
            <div class="d-flex">
                <h1><a href="show_all_product.php">Tất cả sản phẩm</a></h1>
            </div>
            <?php
