...
<body>
    ...
    <div class="container mt-3">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#menu0">Đã mua</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#menu1">Đã nhận</a>
            </li>
        </ul>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ($orders['status'] == 0) {
                                    ...
                                    echo "Đang giao";?>
                                    <a href="checked.php?id=<?php echo $orders['id']?>" class="border">Đã nhận</a>
                                <?php }?>
                            </td>
                        </tr>
                        <?php
